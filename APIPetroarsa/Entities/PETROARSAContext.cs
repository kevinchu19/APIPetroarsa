...
namespace ApiPetroarsa.Entities
{
    public partial class PETROARSAContext : DbContext
    {
        ...
        public virtual DbSet<Vtmclc> Vtmclc_ { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Vtmclc>(entity =>
            {
                ...
                entity.Property(e => e.Vtmclc_Cmpver)
                    .HasMaxLength(10)
                    .IsUnicode(false)
                ...
                entity.Property(e => e.Vtmclc_Hormov)
                    .HasMaxLength(10)
                    .IsUnicode(false)
                    .HasColumnName("VTMCLC_HORMOV");

                entity.Property(e => e.Vtmclc_Lotori)
                    .HasMaxLength(6)
                    .IsUnicode(false)
                    .HasColumnName("VTMCLC_LOTORI");

                entity.Property(e => e.Vtmclc_Lotrec)
                    .HasMaxLength(6)
                    .IsUnicode(false)
                    .HasColumnName("VTMCLC_LOTREC");

                entity.Property(e => e.Vtmclc_Lottra)
                    .HasMaxLength(6)
                    .IsUnicode(false)
                    .HasColumnName("VTMCLC_LOTTRA");

                entity.Property(e => e.Vtmclc_Module)
                    .HasMaxLength(10)
                    .IsUnicode(false)
                ...
                entity.Property(e => e.Vtmclc_Sysver)
                    .HasMaxLength(10)
                    .IsUnicode(false)
