...
namespace ApiPetroarsa.Entities
{
    public partial class Fcrmvh
    {
        ...
        public string Usr_Fcrmvh_Tipfac { get; set; }
        public string Usr_Fcrmvh_Entrega { get; set; }
        public string Usr_Fcrmvh_Tipope { get; set; }
        public int? Usr_Fcrmvh_Nrosgt { get; set; }
        public DateTime? Usr_Fcrmvh_Fchvta { get; set; }
        public string Usr_Fcrmvh_Corrgt { get; set; }
        public string Usr_Fcrmvh_Causbt { get; set; }
        public string Usr_Fcrmvh_Estpre { get; set; }
        public string Usr_Fcrmvh_Motdev { get; set; }
        public string Usr_Fcrmvh_Perare { get; set; }
        public string Usr_Fcrmvh_Plazoe { get; set; }
        public string Usr_Fcrmvh_Facmin { get; set; }
        public string Usr_Fcrmvh_Climin { get; set; }
        public int? Usr_Fcrmvh_Chofer { get; set; }
        public string Usr_Fcrmvh_Patent { get; set; }
        public string Usr_Fcrmvh_Entmin { get; set; }
        public string Usr_Fcrmvh_Nroope { get; set; }
        public string Usr_Fcrmvh_Lugdes { get; set; }
        public string Usr_Fcrmvh_Batnst { get; set; }
        public string Usr_Fcrmvh_Prodie { get; set; }
        public string Usr_Fcrmvh_Turno { get; set; }
        public DateTime? Usr_Fcrmvh_Fchcom { get; set; }
        public string Usr_Fcrmvh_Nrogar { get; set; }
        public string Usr_Fcrmvh_Tipneu { get; set; }
        public string Usr_Fcrmvh_Tipgar { get; set; }
        public string Usr_Fcrmvh_Porrem { get; set; }
        public DateTime? Usr_Fcrmvh_Fcenco { get; set; }
        public string Usr_Fcrmvh_Motaut { get; set; }
        public string Usr_Fcrmvh_Obspre { get; set; }
        public string Usr_Fcrmvh_Motauc { get; set; }
        public string Usr_Fcrmvh_Armaca { get; set; }
        public string Usr_Fcrmvh_Motcor { get; set; }
        public string Usr_Fcrmvh_Motapr { get; set; }
        public string Usr_Fcrmvh_Motcta { get; set; }
        public string Usr_Fcrmvh_Motdve { get; set; }
        public string Usr_Fcrmvh_Motlcr { get; set; }
        public string Usr_Fcrmvh_Resaut { get; set; }
        public decimal? Usr_Fcrmvh_Poracp { get; set; }
        public string Usr_Fcrmvh_Motbri { get; set; }
        public int? Usr_Fcrmvh_Soleva { get; set; }
        public string Usr_Fcrmvh_Proces { get; set; }
        public string Usr_Fcrmvh_Revcod { get; set; }
        public int? Usr_Fcrmvh_Revnro { get; set; }
        public string Usr_Fcrmvh_Aproba { get; set; }
        public string Usr_Fcrmvh_Codfac { get; set; }
        public string Usr_Fcrmvh_Motdes { get; set; }
        ...
        public int? Usr_Fcrmvh_Cupdes { get; set; }
        public string Usr_Fcrmvh_Moncup { get; set; }
        public double? Usr_Fcrmvh_Descup { get; set; }
        public string Fcrmvh_Clasif { get; set; }
        public int? Fcrmvh_Claaut { get; set; }
        public string Usr_Fcrmvh_Circom { get; set; }
        public string Usr_Fcrmvh_Cirapl { get; set; }
        public string Usr_Fcrmvh_Texto2 { get; set; }
        public string Usr_Fcrmvh_Modfnc { get; set; }
        public string Usr_Fcrmvh_Codfnc { get; set; }
        public int? Usr_Fcrmvh_Nrofnc { get; set; }
