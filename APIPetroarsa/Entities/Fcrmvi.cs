...
namespace ApiPetroarsa.Entities
{
    public partial class Fcrmvi
    {
        ...
        public string Usr_Fcrmvi_Ctacte { get; set; }
        public double? Usr_Fcrmvi_Nroint { get; set; }
        public decimal? Usr_Fcrmvi_Costos { get; set; }
        public short? Usr_Fcrmvi_Nrodot { get; set; }
        public string Usr_Fcrmvi_Modfor { get; set; }
        public string Usr_Fcrmvi_Codfor { get; set; }
        public int? Usr_Fcrmvi_Nrofor { get; set; }
        public double? Usr_Fcrmvi_Item { get; set; }
        public string Usr_Fcrmvi_Nserie { get; set; }
